...
function amr_get_lines_to_array (
	...
	//if (WP_DEBUG) {echo '<br/>after search or get:'.count($lines); var_dump($lines);}
	...
	unset($lines);	
	//	if (WP_DEBUG) {echo '<br/>after get lines:'.count($linessaved); var_dump($linessaved);}
	return ($linessaved);
}
/* ------------------------------------------------------------------*/
function amr_convert_indices ($lineitems, $icols) {

		//if (WP_DEBUG) {echo '<br/>before convert csv:'; var_dump($icols);}
...
//------------------------------------------------------------------------------------	 check for search
		...
		// then we are filtering
			//if (amr_debug()) {var_dump($options['filter']); echo '<br />Check for filtering at display time <br />'; var_dump($icols);}
