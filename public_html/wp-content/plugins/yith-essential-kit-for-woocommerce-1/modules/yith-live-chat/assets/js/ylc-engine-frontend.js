    ...
    Plugin.prototype = {
        ...
        init              : function (opts, premium) {
            ...
            this.post('ylc_ajax_callback', 'get_token', {}, function (r) {
                if (!r.error) {
                    ...
                    /*if ( ylc.is_premium && this.opts.styles.autoplay ) {
        ...
        get_template      : function (template, params) {
            ...
            switch (template) {
                ...
                case 'chat-offline-form-premium' :
                    html = ylc.templates.premium.chat_offline_form_premium;
                    break;

                case 'chat-evaluation-premium' :
                    html = ylc.templates.premium.chat_evaluation_premium;
                    break;

                case 'chat-transcript-premium' :
                    html = ylc.templates.premium.chat_transcript_premium;
                    break;

                case 'chat-transcript-btn-premium' :
                    html = ylc.templates.premium.chat_transcript_btn_premium;
                    break;
        ...
        render_btn        : function () {
            ...
            this.el.html(this.get_template('chat-btn', {
                ...
                arrow : (this.opts.styles.y_pos == 'bottom') ? 'up' : 'down'
            }));
        ...
        render_popup      : function () {
            ...
            this.el.append(this.get_template('chat-popup', {
                ...
                arrow        : (this.opts.styles.y_pos == 'bottom') ? 'down' : 'up',
        ...
        validate_username : function (username) {
            ...
            var re = /^[\u0030-\u0039\u0041-\u005A\u0061-\u007A\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF\u0100-\u017F\u0180-\u024F\u0370-\u03FF\u0400-\u04FF\u0530-\u058F\u0590-\u05FF\u0600-\u06FF\u0020\u002D\u002E\u0040\u005F]+$/gim
