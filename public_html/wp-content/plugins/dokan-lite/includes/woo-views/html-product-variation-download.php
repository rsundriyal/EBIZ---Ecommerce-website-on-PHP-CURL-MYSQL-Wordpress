<tr>
	...
	<td class="file_url_choose" width="1%"><a href="#" class="dokan-btn dokan-btn-sm dokan-btn-default upload_file_button" data-choose="<?php _e( 'Choose file', 'woocommerce' ); ?>" data-update="<?php _e( 'Insert file URL', 'woocommerce' ); ?>"><?php echo str_replace( ' ', '&nbsp;', __( 'Choose file', 'woocommerce' ) ); ?></a></td>
	<td width="1%"><a href="#" class="dokan-btn dokan-btn-sm dokan-btn-danger delete"><?php _e( 'Delete', 'woocommerce' ); ?></a></td>
</tr>